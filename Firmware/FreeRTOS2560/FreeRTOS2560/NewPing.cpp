...
//#if defined (__AVR_ATmega32U4__) // Use Timer4 for ATmega32U4 (Teensy/Leonardo).
	...
	TCCR4A = TCCR4C =0;/*= TCCR4D = TCCR4E = 0;*/ //tccr4d and tccr4e commented away  mch
	TCCR4B = (1<<CS42) | (1<<CS41) | (1<<CS40) ;/*| (1<<PSR4);*/ //psr4 commented away mch // Set Timer4 prescaler to 64 (4uS/count, 4uS-1020uS range).
	TIFR4 = (1<<TOV4);
